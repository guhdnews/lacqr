        ...
        <div className="flex flex-col md:flex-row min-h-[calc(100vh-4rem)] max-w-6xl mx-auto p-4 md:p-6 gap-6 md:gap-8">
            ...
            <div className="flex-1 min-w-0">
                ...
                {activeTab === 'booking-page' && (
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 animate-in fade-in slide-in-from-bottom-4 text-center">
                        <h2 className="text-2xl font-black text-charcoal mb-4">Booking Page Configuration</h2>
                        <p className="text-gray-500 mb-8 max-w-md mx-auto">Customize your public booking page with your brand colors, welcome message, and policies.</p>

                        <Link href="/dashboard/settings/booking" className="inline-flex items-center gap-2 bg-charcoal text-white px-8 py-4 rounded-xl font-bold hover:bg-black transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                            <Layout size={20} />
                            Open Booking Editor
                        </Link>
                    </div>
