        ...
        <div className="font-sans text-charcoal">
            ...
            <section className="bg-pink-50 py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <Link
                        href="/signup"
                        className="inline-block bg-charcoal text-white px-8 py-4 rounded-full font-medium text-lg hover:bg-black transition-all shadow-xl hover:scale-105"
                    >
            ...
            <section className="py-24 px-6 text-center">
                <div className="max-w-3xl mx-auto bg-charcoal text-white rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <Link
                            href="/signup"
                            className="inline-block bg-white text-charcoal px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all shadow-xl"
                        >
