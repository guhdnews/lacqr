            ...
            <div className="max-w-6xl mx-auto px-6 py-24 space-y-32">
                ...
                <div className="bg-charcoal rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto space-y-8">
                        ...
                        <Link
                            href="/signup"
                            className="inline-flex items-center gap-2 bg-white text-charcoal px-8 py-4 rounded-full font-bold text-lg hover:bg-pink-50 transition-all shadow-lg hover:scale-105 active:scale-95"
                        >
