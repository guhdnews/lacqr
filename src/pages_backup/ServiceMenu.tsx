                                    ...
                                    <div key={len} className="bg-gray-50 p-4 rounded-xl text-center">
                                        ...
                                        <div className="relative inline-block w-20">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-8 pr-4 py-2 bg-white rounded-lg border border-gray-200 text-center font-bold text-charcoal focus:outline-none focus:border-pink-500"
                                            />
                                        </div>
                                    </div>
                                ))}
