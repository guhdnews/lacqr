                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 hover:shadow-xl transition-all duration-300 relative">
                        ...
                        <button
                            ...
                            className="w-full border-2 border-charcoal text-charcoal py-4 rounded-xl font-bold hover:bg-gray-50 transition-colors mb-8"
                        >
                            Start for Free
                        </button>
                    ...
                    <div className="bg-charcoal text-white rounded-3xl p-8 md:p-12 shadow-2xl relative transform md:-translate-y-4 border border-gray-800">
                        ...
                        <button
                            onClick={() => navigate('/signup')}
                            className="w-full bg-white text-charcoal py-4 rounded-xl font-bold hover:bg-gray-100 transition-colors mb-8 shadow-lg"
                        >
                            Get Pro Access
                        </button>
